...
export const projects: Project[] = [
  ...
  {
    slug: "android-suite", index: "04", title: "Android Suite", shortTitle: "Android Suite", premise: "Four local-first Android tools — notification, clipboard, screenshot, and automation — plus a motion-cue overlay, built as one native suite.",
    status: "Shipped", maturity: "Signed release bundles and Play Store assets", year: "2024—26", featuredOrder: 4,
    domains: ["NATIVE", "MOBILE"], ownership: "Creator", visibility: "public", role: "Creator · native product and release engineering",
    summary: "The Android Suite collects four independent local-first tools into one coherent native surface: notification reminders, clipboard snippets, screenshot organization with OCR, and simple automation with geofences — plus a sensor-driven motion-cue overlay. Each ships with Free/Pro flavors and its own store listing.",
    challenge: "Local-first Android apps must handle media, sensors, permissions, billing, and background work without becoming a tangled monolith.",
    intervention: "I built each app as an independent Gradle module with shared conventions, then grouped them as a portfolio with unified release artifacts and Play Store listings.",
    decision: "Treat each tool as a standalone product with shared taste, not as features inside one oversized app.",
    proof: ["Four apps plus VehicleMotionCues, each with Free/Pro variants and signed AABs.", "WorkManager, ML Kit, MediaStore, and Play Billing integrated where needed.", "Store listings, icons, and feature graphics produced for all four."],
    lessons: "A suite teaches more than one app: each tool refines the taste that the next tool inherits.",
    stack: ["Kotlin", "Jetpack Compose", "Gradle", "ML Kit", "WorkManager", "Play Billing"], links: [{ label: "VehicleMotionCues", href: "https://github.com/7HR4IZ3/VehicleMotionCues" }], module: "motion",
    media: { src: "/projects/android-suite.svg", alt: "Android Suite — four local-first tools on device", kind: "product-capture", width: 1200, height: 720, approved: true },
    gallery: [
      { src: "/projects/gallery/android-suite/suite.svg", alt: "Android Suite overview of four apps", kind: "product-capture", width: 1200, height: 720, approved: true },
      { src: "/projects/gallery/android-suite/motion.svg", alt: "Motion overlay sensor dots system capture", kind: "product-capture", width: 1200, height: 720, approved: true },
      { src: "/projects/gallery/android-suite/automation.svg", alt: "Automation rules and geofence capture", kind: "product-capture", width: 1200, height: 720, approved: true },
    ],
  },

  {
    slug: "motion-cues", index: "33", title: "Motion Cues", shortTitle: "Motion", premise: "A native Android overlay that turns vehicle movement into a quiet visual reference above other applications.",
    status: "Shipped", maturity: "Release build and store assets produced", year: "2026", featuredOrder: null,
  ...
  {
    slug: "opencode-annotate", index: "34", title: "OpenCode Annotate", shortTitle: "Annotate", premise: "Select an interface in the browser and route that exact feedback into the coding-agent session that owns it.",
    status: "Open source", maturity: "Published browser and agent-session workflow", year: "2026", featuredOrder: null,
  ...
  {
    slug: "stackjet", index: "35", title: "Stackjet", shortTitle: "Stackjet", premise: "A remote file URL travels directly into cloud storage without using the person's device as a temporary warehouse.",
    status: "Active build", maturity: "Google Drive upload workflow implemented", year: "2026", featuredOrder: null,
  ...
  {
    slug: "antichess", index: "05", title: "AntiChess", shortTitle: "AntiChess", premise: "An early platform for playing chess against different AI models and comparing their behavior.",
    status: "Active build", maturity: "Playable prototype with multi-model comparison", year: "2024—26", featuredOrder: 5,
    domains: ["AI", "TOOLING"], ownership: "Creator", visibility: "public", role: "Creator · architecture and game logic",
    ...
    media: { src: "/projects/antichess.svg", alt: "AntiChess board comparing AI model reasoning", kind: "product-capture", width: 1200, height: 720, approved: true },
    gallery: [
      { src: "/projects/gallery/antichess/board.svg", alt: "AntiChess chess board with AI comparison", kind: "product-capture", width: 1200, height: 720, approved: true },
      { src: "/projects/gallery/antichess/models.svg", alt: "AntiChess AI model reasoning comparison", kind: "architecture-capture", width: 1200, height: 720, approved: true },
      { src: "/projects/gallery/antichess/theme.svg", alt: "AntiChess custom chess theme and board styling", kind: "product-capture", width: 1200, height: 720, approved: true },
    ],
  },
  {
  ...
  {
    slug: "wsgic-bridgeio", index: "06", title: "WSGIC + BridgeIO Ecosystem", shortTitle: "BridgeIO", premise: "A Python web framework and a family of cross-language bridges that let Python, JavaScript, and the browser call each other directly.",
    status: "Open source", maturity: "Public framework experiments with working demos", year: "2023—25", featuredOrder: 6,
    ...
    media: { src: "/projects/bridgeio.svg", alt: "BridgeIO cross-language bridge architecture", kind: "architecture-capture", width: 1200, height: 720, approved: true },
    gallery: [
      { src: "/projects/gallery/bridgeio/architecture.svg", alt: "BridgeIO Python-JS-browser bridge path", kind: "architecture-capture", width: 1200, height: 720, approved: true },
      { src: "/projects/gallery/bridgeio/demo.svg", alt: "BridgeIO ExpressPy and virtual-dom demos", kind: "product-capture", width: 1200, height: 720, approved: true },
      { src: "/projects/gallery/bridgeio/transpiler.svg", alt: "BridgeIO ES6 to Python transpiler evidence", kind: "terminal-capture", width: 1200, height: 720, approved: true },
    ],
  },
  {
