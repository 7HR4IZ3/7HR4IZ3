  ...
  return (
    <PageShell>
      <header className="index-intro index-intro--lab">
        <div><span>LAB / UNMERGED BRANCHES</span><span>{String(labProjects.length).padStart(2, "0")} ACTIVE RECORDS</span></div>
      ...
      <section className="project-index" aria-label="Early products and experiments">
